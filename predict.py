...
def show_predict_page():
    ...
    file_ = open("/opt/render/project/src/PREDICT THE BITCOIN/Bitcoin.gif", "rb")
    contents = file_.read()
    ...
    startDate = st.date_input("Select Start Date for price prediction", value=datetime.datetime(2023,8,23),min_value=datetime.datetime(2014,9,17))
    endDate = st.date_input("Select End Date for price prediction", value=datetime.datetime(2023,8,30),min_value=datetime.datetime(2014,9,17))
    ...
    if country == 'USA':
      ...
      specificdate = st.date_input("Select A Day for price prediction", value=datetime.datetime(2023,8,25),min_value=datetime.datetime.now())
